...
export default function Footer() {
  return (
    <footer className="bg-slate-50 border-t border-slate-200 mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-4 md:py-8 flex flex-col items-center justify-center text-center">
        ...
        {/* Baris 2: Info Hibah */}
        <div className="text-[10px] md:text-sm font-medium text-slate-500 mb-1.5 md:mb-2">
